...
\begin{contract}
    ...
    Er hat seinen Sitz in der Martin-Luther-Straße 15 in 01099 Dresden.
    ...
    Der Verein verfolgt ausschließlich und unmittelbar gemeinnützige Zwecke im Sinne des Abschnitts \enquote{Steuerbegünstigte Zwecke} der Abgabenordnung.
    \label{zweckbindung}

    Zweck des \name ist die Förderung von Kunst und Kultur nach \S 58 Abs. 2 Nr. 5 AO.
    Der Satzungszweck wird verwirklicht insbesondere durch die eigenständige Planung und Durchführung von Versanstaltungen, Ausstellungen und Workshops.

    Im Rahmen dieser Veranstaltungen, Ausstellungen und Workshops verfolgt der \name das Ziel die Gleichberechtigung von Frauen und Männern nach \S 52 Abs. 2 Nr. 18 AO durch ausgeglichene Vertretung der Künstler..innen zu fördern.

    Des Weiteren verfolgt der \name die Förderung des Naturschutzes und der Landschaftspflege im Sinne des Bundesnaturschutzgesetzes und der Naturschutzgesetze der Länder, des Umweltschutzes, einschließlich des Klimaschutzes, des Küstenschutzes und des Hochwasserschutzes nach \S 52 Abs. 2 Ne. 8 AS.
    Der Satzungszweck wird verwirklicht insbesondere durch den Einsatz überschüssiger Mittel die durch den Betrieb des \name entstehen können.
